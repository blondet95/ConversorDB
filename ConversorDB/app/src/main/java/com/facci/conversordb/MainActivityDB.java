...
public class MainActivityDB extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_activity_db);
    ...
    public void clickConvert(View v){
        ...
        }else
        {
            ...
            Toast.makeText(MainActivityDB.this,"Las opciones elegidas no tiene un factor de conversor", Toast.LENGTH_SHORT).show();
        }
    }
